...
export default async function shortenUrlOperaton(url: string): Promise<ShortenUrlResponse | ErrorResponse> {
    ...
    try {
        const rawResponse = await fetch('http://localhost:8080/shorten', requestConfig)
        if (!rawResponse.ok) {
